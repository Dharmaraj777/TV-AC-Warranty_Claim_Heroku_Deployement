...
def user_input_features():
    ...
    Region = st.sidebar.selectbox("Region",region_options, format_func=lambda x:region_display[x], key="1")
    ...
    State = st.sidebar.selectbox("State",state_options, format_func=lambda x: state_display[x],key="2")
    area_display = ('Urban', 'Rural')
    area_options = list(range(len(area_display)))
    Area = st.sidebar.selectbox("Area",area_options, format_func=lambda x: area_display[x],key="3")
    ...
    City = st.sidebar.selectbox("City",city_options, format_func=lambda x: city_display[x],key="4")
    Consumer_profile = st.sidebar.selectbox('Consumer_profile',("Business","Personal"), key="5")
    Product_category = st.sidebar.selectbox('Product_category',("Entertainment","Household"), key="6")
    Product_type = st.sidebar.selectbox('Product_type',("TV","AC"),key="7")
    ## AC_1001_Issue
    AC_1001_Issue_display = ('No Issue','Repair','Replacement')
    AC_1001_Issue_options = list(range(len(AC_1001_Issue_display)))
    AC_1001_Issue = st.sidebar.selectbox("AC 1001 Issue",AC_1001_Issue_options, format_func=lambda x: AC_1001_Issue_display[x], key="8")
   ...
   ## AC_1002_Issue
    ...
    AC_1002_Issue = st.sidebar.selectbox("AC 1002 Issue",AC_1002_Issue_options, format_func=lambda x: AC_1002_Issue_display[x],key="9")
   ...
   ## AC_1003_Issue
    ...
    AC_1003_Issue = st.sidebar.selectbox("AC 1002 Issue",AC_1003_Issue_options, format_func=lambda x: AC_1003_Issue_display[x], key="10")
 ...
 ## TV_2001_Issue
    ...
    TV_2001_Issue = st.sidebar.selectbox("TV 2001 Issue",TV_2001_Issue_options, format_func=lambda x: TV_2001_Issue_display[x], key="11")
 ...
 ## TV_2002_Issue
    ...
    TV_2002_Issue = st.sidebar.selectbox("TV 2002 Issue",TV_2002_Issue_options, format_func=lambda x: TV_2002_Issue_display[x], key="12")
 ...
 ## TV_2003_Issue
    ...
    TV_2003_Issue = st.sidebar.selectbox("TV 2003 Issue",TV_2003_Issue_options, format_func=lambda x: TV_2003_Issue_display[x], key="13")
    ...
    Claim_Value  = st.sidebar.number_input("Insert the claim value", key="14")
    service_centre_display = [10, 12, 14, 16, 15, 13, 11]
    service_centre_options = list(range(len(service_centre_display)))
    Service_Centre = st.sidebar.selectbox("Service Centre Code",service_centre_options, format_func=lambda x: service_centre_display[x], key="15")
    Product_Age = st.sidebar.number_input("Insert the product age", key="16")
    Purchased_from = st.sidebar.selectbox('Purchased_from',("Manufacturer","Dealer","Internet"), key="17")
    Call_details = st.sidebar.number_input("Insert the call details", key="18")
    Purpose = st.sidebar.selectbox('Purpose',("Complaint","Claim","Other"), key="19")
